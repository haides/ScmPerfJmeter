 ...
 * File Name:TestBatchUpLoad.java
 * 类的详细描述
 *
 *  @author 类创建者姓名
 * Date:2018-7-30下午12:36:15
 *  @version 1.00
 */
...
public class TestBatchUpLoad extends AbstractJavaSamplerClient{
    private ScmOperator oper = null ;

    @Override
    public Arguments getDefaultParameters() {
        Arguments args = new Arguments() ;
        args.addArgument( Common.CASENAME, "batchupload" ) ;
        ...
        args.addArgument( Common.BATCHSIZE, "10" ) ;
        args.addArgument( Common.FILENUMPERFILESIZE, "5,3,1,1" ) ;
        return args ;
    ...
    public SampleResult runTest( JavaSamplerContext arg0 ) {
        ...
        int fileNum = Integer.parseInt( arg0.getParameter( Common.BATCHSIZE ) ) ;
        String[] weights = arg0.getParameter( Common.FILENUMPERFILESIZE ).split( "," ) ;
        rs.sampleStart() ;
        rs.setDataType( SampleResult.TEXT ) ;
        try{
            oper.uploadUseBatch( fileNum, weights ) ;
