 ...
 * File Name:TestUploadByObj.java
 * 类的详细描述
 *
 *  @author 类创建者姓名
 * Date:2018-7-30下午12:22:14
 *  @version 1.00
 */
...
public class TestUploadByObj extends AbstractJavaSamplerClient{
    private SdbOperator oper = null ;
    
    @Override
    public Arguments getDefaultParameters() {
        Arguments args = new Arguments() ;
        args.addArgument( Common.CASENAME, "uploadbyobj" ) ;
        ...
        args.addArgument( Common.FILESIZE, "204800" ) ;
