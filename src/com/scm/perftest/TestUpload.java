 ...
 * File Name:TestUpload.java
 * 类的详细描述
 *
 *  @author 类创建者姓名
 * Date:2018-7-29下午5:03:04
 *  @version 1.00
 */
...
public class TestUpload extends AbstractJavaSamplerClient {
    ...
    public Arguments getDefaultParameters() {
        ...
        args.addArgument( Common.CASENAME, "upload" ) ;
        ...
        args.addArgument( Common.FILESIZE, "102400" ) ;
        args.addArgument( Common.USEDBREAKPOINTFILE, "false" ) ;
        args.addArgument( Common.FILENUMPERDIR, "1000" ) ;
        return args ;
    }
    ...
    public void setupTest( JavaSamplerContext args ) { 
        ...
        prop.setProperty( Common.FILENUMPERDIR, args.getParameter( Common.FILENUMPERDIR ) ) ;
        try {
    ...
    public SampleResult runTest( JavaSamplerContext arg0 ) {
        ...
        int fileSize = arg0.getIntParameter( Common.FILESIZE ) ;
        boolean useBreakpointFile = Boolean.parseBoolean( arg0.getParameter( Common.USEDBREAKPOINTFILE )) ;
        SampleResult rs = new SampleResult() ;
        rs.setSampleLabel( arg0.getParameter( Common.CASENAME ) ) ;
        rs.sampleStart() ;
        rs.setDataType( SampleResult.TEXT ) ;
        try{
            oper.upLoad( fileSize, useBreakpointFile ) ;
