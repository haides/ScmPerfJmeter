...
public class TestDownLoad extends AbstractJavaSamplerClient {
    private ScmOperator oper = null ;

    @Override
    public Arguments getDefaultParameters() {
        Arguments args = new Arguments() ;
        args.addArgument( Common.CASENAME, "downLoad" ) ;
    ...
    public void setupTest( JavaSamplerContext args ) {  
        ...
        prop.setProperty( Common.FILESIZE, args.getParameter(Common.FILESIZE) ) ;
        try {
