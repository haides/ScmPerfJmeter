 ...
 * File Name:TestGetSingleTypeFileAttr.java
 * 类的详细描述
 *
 *  @author 类创建者姓名
 * Date:2018-7-30下午4:00:27
 *  @version 1.00
 */
...
public class TestGetSingleTypeFileAttr extends AbstractJavaSamplerClient {
    private ScmOperator oper = null ;

    @Override
    public Arguments getDefaultParameters() {
        Arguments args = new Arguments() ;
        args.addArgument( Common.CASENAME, "getfileattr_singletype" ) ;
        ...
        args.addArgument( Common.FILEATTRNUM, "1" ) ;
        return args ;
    }
    ...
    public void setupTest( JavaSamplerContext args ) {
        ...
        prop.setProperty( Common.GATEWAYURL,
                args.getParameter( Common.GATEWAYURL ) ) ;
    ...
    public SampleResult runTest( JavaSamplerContext arg0 ) {
        ...
        int fileAttrNum = arg0.getIntParameter( Common.FILEATTRNUM ) ;
        ...
        try {
            oper.getFileObjs( fileAttrNum, false ) ;
