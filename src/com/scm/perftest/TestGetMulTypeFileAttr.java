 ...
 * File Name:TestGetMulTypeFileAttr.java
 * 类的详细描述
 *
 *  @author 类创建者姓名
 * Date:2018-7-30下午4:00:52
 *  @version 1.00
 */
...
public class TestGetMulTypeFileAttr extends AbstractJavaSamplerClient {
    private ScmOperator oper = null ;

    @Override
    public Arguments getDefaultParameters() {
        Arguments args = new Arguments() ;
        args.addArgument( Common.CASENAME, "getfileattr_multype" ) ;
    ...
    public SampleResult runTest( JavaSamplerContext arg0 ) {
        ...
        try {
            oper.getFileObjs( fileAttrNum, true ) ;
